...
exports.createIncident = async (req, res) => {
  try {
    ...
    // Process uploaded file paths if files were provided by multer
    let evidenceFiles = [];
...
exports.getIncidentById = async (req, res) => {
  try {
    ...
    // Authorization check: User can only view their own incident unless they are Admin/Volunteer/Police
